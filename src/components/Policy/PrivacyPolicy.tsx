    ...
    return (
        <div className="bg-[#eef6fc] py-10 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <h2 className="text-sm font-bold text-gray-800 mb-4">1. Thu thập thông tin cá nhân</h2>
                <p className="text-sm font-semibold text-gray-700 mb-4">
                ...
                {/* Section 2: Bảo mật */}
                <h2 className="text-sm font-bold text-gray-800 mb-4">2. Bảo mật</h2>
                <p className="text-sm font-semibold text-gray-700 mb-4">
                ...
                {/* Section 3: Quyền lợi khách hàng */}
                <h2 className="text-sm font-bold text-gray-800 mb-4">3. Quyền lợi khách hàng</h2>
